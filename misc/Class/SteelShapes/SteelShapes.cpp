...
private:
    ...
    double B; 	 	 	 	 // Overall_width_of_square/rectangular_HSS 
    ...
    double T; 	 	 	 	 // Distance_between_web_toes_of_fillets 
...
public:
    ...
    SteelShapes(const std::string shape_name);
...
SteelShapes::SteelShapes(const std::string shape_name) : EDI_Name(shape_name) {
    std::cout << "I'm inside the constructor\n";
    std::cout << "The variable got set to the private one = " << EDI_Name << "\n";
}
