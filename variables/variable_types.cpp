...
#include <iomanip>
#include <format>     // C++20
#include <concepts>   // Optional, for better constraints
...
int main() {
    ...
    long long int d = 9223372036854775807;  // max size is based on a +/- 9,223,372,036,854,775,807 which is (2^64/2 -1)  (8 byte)
